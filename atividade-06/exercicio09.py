# Escreva uma função que percorra uma árvore binária e retorne True caso ela seja uma árvore binária de
# busca e False caso contrário. Tal função deve ter o seguinte protótipo: def ehABB(a)
...
def ehABB(root):
    ...
    if root.esquerda and root.esquerda.chave > root.chave:
        return False

    if root.direita and root.direita.chave < root.chave:
        return False

    return ehABB(root.esquerda) and ehABB(root.direita)
